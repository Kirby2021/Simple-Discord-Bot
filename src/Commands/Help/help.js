...
try {
    ...
    const embed = new Discord.MessageEmbed()
    .setTimestamp()
    .setTitle(`Welcome to ${message.guild.name}'s help menu!`)
    .setDescription(`Press on the button below to select your desired menu, you will find all my commands`)
    .setColor('BLURPLE')
    ...
    collector.on('collect', async (i) => {
        if (i.user.id !== member.id) return message.reply({content: 'This is not for you!', ephemeral: true})
