...
type: "Text",
    ...
    .setTitle(`${errorX} MISSING ARGUEMENT`)
        ...
        .setColor(c['light red'])
        .setDescription(" You have same the role level as who you are trying to ban!")
        .setTitle(`${errorX} An Error Occured`)
    ...
    .setColor("RED")
    .setDescription(" Please provide a reason to why this user is being banned!")
    .setTitle(`${errorX} MISSING ARGUEMENT`)
